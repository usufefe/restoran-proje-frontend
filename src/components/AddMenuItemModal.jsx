    ...
    <div className="space-y-8">
      ...
      <Card className="border-2 border-gray-200 rounded-2xl bg-gradient-to-br from-gray-50 to-white">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-3 sm:gap-4 md:gap-6">
    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="nutrition" className="w-full">
        ...
        <TabsContent value="nutrition" className="space-y-4 mt-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-3 sm:gap-4 md:gap-6">
            <div className="space-y-2">
        ...
        {step === 1 ? (
          <>
            ...
            <div className="flex-1 overflow-y-auto px-3 sm:px-4 lg:px-8">
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8 py-4 sm:py-6">
            ...
            <DialogFooter className="flex-shrink-0 flex flex-col sm:flex-row justify-between gap-3 sm:gap-0 pt-4 sm:pt-6 pb-3 sm:pb-4 border-t px-3 sm:px-4 lg:px-8">
              <div className="flex space-x-2">
                <Button 
                  ...
                  variant="outline" 
                  onClick={handleClose}
                  className="px-4 sm:px-6 py-3 sm:py-3 border-2 border-gray-200 text-gray-600 hover:bg-gray-50 rounded-2xl text-sm sm:text-base"
                >
                ...
                {currentStep > 1 && (
                  <Button 
                    ...
                    className="px-4 sm:px-6 py-3 sm:py-3 border-2 border-purple-200 text-purple-600 hover:bg-purple-50 rounded-2xl text-sm sm:text-base"
                  >
              ...
              <div className="flex space-x-2">
                {currentStep < 4 ? (
                  <Button 
                    ...
                    className="px-4 sm:px-6 py-3 sm:py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-xl rounded-2xl text-sm sm:text-base"
                  >
                    İleri
                  ...
                  <Button 
                    type="submit" 
                    disabled={isLoading}
                    className="px-6 sm:px-8 py-3 sm:py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white shadow-xl rounded-2xl text-sm sm:text-base"
                  >
                    {isLoading ? (
                      <>
